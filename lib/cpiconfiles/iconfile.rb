  ...
  class Iconfile
    ...
    def determine_icon_size(_basename)
      if @valid_ext
        ...
        if @icon_size > Sizepattern.MAX_ICON_SIZE
          @icon_size = -1
          @valid_name = false
    ...
    def part_name
      ...
      ret = array.each_with_object([]) { |str, arrayx|
        if str != nil && !str.strip.nil?
          arrayx << str
        end
      }
      ret
